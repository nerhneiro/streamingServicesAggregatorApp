...
import json
import os
from discogs_api import Client
from discogs_api.fetchers import LoggingDelegator, FilesystemFetcher, \
    MemoryFetcher
...
def suite():
    from discogs_api.tests import test_core, test_models, test_fetchers
